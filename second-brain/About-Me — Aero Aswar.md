---
type: about
tags: [about-me, identity, profile]
updated: 2026-06-19
---
# About-Me — Aero Aswar

> Profile note. Keep this current — it's the single source of truth on "who I am"
> for future me and any AI assistant. See also [[START-HERE]].

## Identity
- **Name:** Aero Aswar · **Email:** aeroaswar@gmail.com · **Base:** Indonesia (IDR).
- **Core identity:** professional **jetski racer** ("Born on Water"), now also a
  **designer / creative technologist / founder**. Bold, sporty, water-born brand
  with an Indonesian Merah-Putih (red/white) accent.
...
- **Systems thinker.** I build compounding, machine-parseable knowledge bases and
  let AI maintain them; I curate and direct.
- **Taste-driven.** Premium, airy, restrained design; sports energy; no purple.
- **Decisive.** Prefer a clear recommendation + action over exhaustive options.
- **Sustainability + community** as brand pillars (esp. GLU).

## Signature aesthetic
- Type Geist/Italiana/Merah-Putih palettes; mint glass, warm-white canvas, navy ink,
