...
type: skill
origin: made
what: Full SKILL.md for gstack (headless-browser QA / screenshots / dogfooding)
tags: [skill, qa, browser, testing]
---
# gstack (full)

> Full source of my **gstack** skill (catalog: [[gstack]]). v1.1.0. Imported verbatim from `gstack-SKILL.md`.

---

name: gstack preamble-tier: 1 version: 1.1.0 description: Fast headless browser for QA testing and site dogfooding. (gstack) allowed-tools:
...
Navigate pages, interact with elements, verify state, diff before/after, take annotated screenshots, test responsive layouts, forms, uploads, dialogs, and capture bug evidence. Use when asked to open or test a site, verify a deployment, dogfood a user flow, or file a bug with screenshots.
...
**Cookie safety:** cookie-import-browser transfers real session data. Only import cookies from browsers you control.
...
| goto \\<url\\> | Navigate to URL (http://, https://, or file:// scoped to cwd/TEMP\\_DIR) |
