...
Keyframing the `ctrl["reveal"]` property now drivers the logo's scale via the driver. This is cleaner than keyframing scale directly when multiple objects share the same reveal timing.
