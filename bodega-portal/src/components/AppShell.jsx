...
import {
  ...
  ChevronDown, Sun, Moon, Menu, LogOut, Check, Bell, ArrowUpRight, Building2, FileSignature, Receipt,
} from "lucide-react";
import {
...
const NAV_GROUPS = [
  ...
  { title: "Billing", items: [
    { href: "/app/invoices", label: "Invoices", icon: Receipt, roles: ["admin", "team", "client"] },
  ] },
  { title: "System", items: [
