    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between p-12 overflow-hidden">
        <div className="flex flex-col gap-3 items-start">
          <a href="/" className="flex items-center gap-2" title="Back to bodega.com">
            <span className="w-3 h-3 rounded-full" style={{ background: "#e8743b", boxShadow: "0 0 16px 2px rgba(37,98,231,.7)" }} />
            <span className="display text-2xl font-extrabold">bodega</span>
          </a>
          <a href="/" className="flex items-center gap-1.5 text-faint text-sm hover:text-[color:var(--text)] transition-colors">
      ...
      <div className="flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} className="glass w-full max-w-md p-7">
          <div className="lg:hidden flex items-center justify-between mb-6">
            <a href="/" className="flex items-center gap-2" title="Back to bodega.com">
              <span className="w-2.5 h-2.5 rounded-full" style={{ background: "#e8743b" }} />
              <span className="display text-xl font-extrabold">bodega</span>
            </a>
            <a href="/" className="flex items-center gap-1.5 text-faint text-xs hover:text-[color:var(--text)] transition-colors">
