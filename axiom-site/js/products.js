...
(function () {
  ...
  var PRODUCTS = [
    ...
    { id: 'pep-cagri-10',   pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Cagrilintide',            spec: '10 mg lot · lyophilate', price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-reta-5',     pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '5 mg lot · lyophilate',  price: 2700000, ruo: true, art: 'pen' },
    { id: 'pep-reta-10',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '10 mg lot · lyophilate', price: 3100000, ruo: true, art: 'pen' },
    { id: 'pep-reta-15',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '15 mg lot · lyophilate', price: 3500000, ruo: true, art: 'pen' },
    { id: 'pep-reta-20',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '20 mg lot · lyophilate', price: 3900000, ruo: true, art: 'pen' },
    { id: 'pep-reta-30',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '30 mg lot · lyophilate', price: 5100000, ruo: true, art: 'pen' },
    { id: 'pep-reta-60',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Retatrutide',             spec: '60 mg lot · lyophilate', price: 8300000, ruo: true, art: 'pen' },
    { id: 'pep-tirz-10',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Tirzepatide',             spec: '10 mg lot · lyophilate', price: 2400000, ruo: true, art: 'pen' },
    { id: 'pep-tirz-30',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Tirzepatide',             spec: '30 mg lot · lyophilate', price: 3800000, ruo: true, art: 'pen' },
    { id: 'pep-tirz-40',    pillar: 'peptide', cat: 'GLP-1s & Weight Loss', name: 'Tirzepatide',             spec: '40 mg lot · lyophilate', price: 4500000, ruo: true, art: 'pen' },
    // 02 · GH Secretagogues
    { id: 'pep-cjcipa-10',  pillar: 'peptide', cat: 'GH Secretagogues', name: 'CJC-1295 (No DAC) + Ipamorelin', spec: '10 mg lot · blend',  price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-cjcipa-20',  pillar: 'peptide', cat: 'GH Secretagogues', name: 'CJC-1295 (No DAC) + Ipamorelin', spec: '20 mg lot · blend',  price: 4300000, ruo: true, art: 'pen' },
    { id: 'pep-hgh-36',     pillar: 'peptide', cat: 'GH Secretagogues', name: 'HGH 191AA (Somatropin)',      spec: '36 IU lot',              price: 3200000, ruo: true, art: 'pen' },
    { id: 'pep-hgh-40',     pillar: 'peptide', cat: 'GH Secretagogues', name: 'HGH 191AA (Somatropin)',      spec: '40 IU lot',              price: 3600000, ruo: true, art: 'pen' },
    { id: 'pep-ipam-10',    pillar: 'peptide', cat: 'GH Secretagogues', name: 'Ipamorelin',                  spec: '10 mg lot · lyophilate', price: 2800000, ruo: true, art: 'pen' },
    { id: 'pep-ipatesa-18', pillar: 'peptide', cat: 'GH Secretagogues', name: 'Ipamorelin + Tesamorelin',    spec: '18 mg lot · blend',      price: 5000000, ruo: true, art: 'pen' },
    { id: 'pep-tesa-10',    pillar: 'peptide', cat: 'GH Secretagogues', name: 'Tesamorelin',                 spec: '10 mg lot · lyophilate', price: 3600000, ruo: true, art: 'pen' },
    { id: 'pep-tesa-20',    pillar: 'peptide', cat: 'GH Secretagogues', name: 'Tesamorelin',                 spec: '20 mg lot · lyophilate', price: 4700000, ruo: true, art: 'pen' },
    // 03 · Healing & Repair
    { id: 'pep-bpc157-10',  pillar: 'peptide', cat: 'Healing & Repair', name: 'BPC-157',                     spec: '10 mg lot · lyophilate', price: 2700000, ruo: true, art: 'pen' },
    { id: 'pep-wolv-20',    pillar: 'peptide', cat: 'Healing & Repair', name: 'BPC-157 + TB-500 (Wolverine)', spec: '20 mg lot · blend',     price: 3900000, ruo: true, art: 'pen' },
    { id: 'pep-ghkcu-50',   pillar: 'peptide', cat: 'Healing & Repair', name: 'GHK-Cu',                      spec: '50 mg lot · copper peptide', price: 2100000, ruo: true, art: 'pen' },
    { id: 'pep-ghkcu-100',  pillar: 'peptide', cat: 'Healing & Repair', name: 'GHK-Cu',                      spec: '100 mg lot · copper peptide', price: 2300000, ruo: true, art: 'pen' },
    { id: 'pep-kpv-10',     pillar: 'peptide', cat: 'Healing & Repair', name: 'KPV',                         spec: '10 mg lot · lyophilate', price: 2600000, ruo: true, art: 'pen' },
    { id: 'pep-klow-80',    pillar: 'peptide', cat: 'Healing & Repair', name: 'KLOW (BPC+TB+GHK+KPV)',       spec: '80 mg lot · blend',      price: 4400000, ruo: true, art: 'pen' },
    { id: 'pep-ll37-5',     pillar: 'peptide', cat: 'Healing & Repair', name: 'LL-37',                       spec: '5 mg lot · lyophilate',  price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-pegmgf-2',   pillar: 'peptide', cat: 'Healing & Repair', name: 'Peg MGF',                     spec: '2 mg lot · lyophilate',  price: 3100000, ruo: true, art: 'pen' },
    { id: 'pep-tb500-10',   pillar: 'peptide', cat: 'Healing & Repair', name: 'TB-500',                      spec: '10 mg lot · lyophilate', price: 2900000, ruo: true, art: 'pen' },
    // 04 · Brain Health & Nootropics
    { id: 'pep-adamax-10',  pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Adamax',             spec: '10 mg lot · lyophilate', price: 3100000, ruo: true, art: 'pen' },
    { id: 'pep-cere-60',    pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Cerebrolysin',       spec: '60 mg lot',              price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-pine-20',    pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Pinealon',           spec: '20 mg lot · lyophilate', price: 3600000, ruo: true, art: 'pen' },
    { id: 'pep-selank-10',  pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Selank',             spec: '10 mg lot · lyophilate', price: 2300000, ruo: true, art: 'pen' },
    { id: 'pep-semax-10',   pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Semax',              spec: '10 mg lot · lyophilate', price: 2300000, ruo: true, art: 'pen' },
    { id: 'pep-selsem-20',  pillar: 'peptide', cat: 'Brain Health & Nootropics', name: 'Selank + Semax',     spec: '20 mg lot · blend',      price: 3200000, ruo: true, art: 'pen' },
    // 05 · Energy & Endurance
    { id: 'pep-5amino-50',  pillar: 'peptide', cat: 'Energy & Endurance', name: '5-Amino-1MQ',               spec: '50 mg lot',              price: 3200000, ruo: true, art: 'pen' },
    { id: 'pep-aicar-50',   pillar: 'peptide', cat: 'Energy & Endurance', name: 'AICAR',                     spec: '50 mg lot · lyophilate', price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-lcar-5000',  pillar: 'peptide', cat: 'Energy & Endurance', name: 'L-Carnitine (Injectable)',  spec: '5 000 mg lot',           price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-motsc-10',   pillar: 'peptide', cat: 'Energy & Endurance', name: 'MOTS-c',                    spec: '10 mg lot · lyophilate', price: 2400000, ruo: true, art: 'pen' },
    { id: 'pep-motsc-40',   pillar: 'peptide', cat: 'Energy & Endurance', name: 'MOTS-c',                    spec: '40 mg lot · lyophilate', price: 4300000, ruo: true, art: 'pen' },
    { id: 'pep-slupp-5',    pillar: 'peptide', cat: 'Energy & Endurance', name: 'SLU-PP-332 (Injectable)',   spec: '5 mg lot',               price: 2700000, ruo: true, art: 'pen' },
    // 06 · Immunity
    { id: 'pep-ta1-10',     pillar: 'peptide', cat: 'Immunity', name: 'Thymosin Alpha-1',                    spec: '10 mg lot · lyophilate', price: 3600000, ruo: true, art: 'pen' },
    // 07 · Sexual Health
    { id: 'pep-hcg-10000',  pillar: 'peptide', cat: 'Sexual Health', name: 'HCG',                            spec: '10 000 IU lot',          price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-hmg-75',     pillar: 'peptide', cat: 'Sexual Health', name: 'HMG',                            spec: '75 IU lot',              price: 2700000, ruo: true, art: 'pen' },
    { id: 'pep-kiss-10',    pillar: 'peptide', cat: 'Sexual Health', name: 'Kisspeptin',                     spec: '10 mg lot · lyophilate', price: 3200000, ruo: true, art: 'pen' },
    { id: 'pep-oxy-10',     pillar: 'peptide', cat: 'Sexual Health', name: 'Oxytocin Acetate',               spec: '10 mg lot · lyophilate', price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-pt141-10',   pillar: 'peptide', cat: 'Sexual Health', name: 'PT-141',                         spec: '10 mg lot · lyophilate', price: 2600000, ruo: true, art: 'pen' },
    // 08 · Longevity & Cellular Repair
    { id: 'pep-dsip-5',     pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'DSIP',             spec: '5 mg lot · lyophilate',  price: 2100000, ruo: true, art: 'pen' },
    { id: 'pep-dsip-10',    pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'DSIP',             spec: '10 mg lot · lyophilate', price: 2600000, ruo: true, art: 'pen' },
    { id: 'pep-epi-50',     pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'Epithalon',        spec: '50 mg lot · lyophilate', price: 3400000, ruo: true, art: 'pen' },
    { id: 'pep-hum-10',     pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'Humanin',          spec: '10 mg lot · lyophilate', price: 4500000, ruo: true, art: 'pen' },
    { id: 'pep-nad-500',    pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'NAD+',             spec: '500 mg lot',             price: 2600000, ruo: true, art: 'pen' },
    { id: 'pep-nad-1000',   pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'NAD+',             spec: '1 000 mg lot',           price: 3000000, ruo: true, art: 'pen' },
    { id: 'pep-ss31-50',    pillar: 'peptide', cat: 'Longevity & Cellular Repair', name: 'SS-31',            spec: '50 mg lot · lyophilate', price: 4500000, ruo: true, art: 'pen' },
    // Research supplies
  ...
  var ART = {
    pen:   '<line x1="60" y1="17" x2="60" y2="26"/><path d="M56 32 57.5 26 62.5 26 64 32Z"/><rect x="50" y="32" width="20" height="35" rx="4"/><line x1="55" y1="44" x2="65" y2="44" opacity=".5"/><rect x="48" y="67" width="24" height="30" rx="5"/><line x1="54" y1="77" x2="66" y2="77" opacity=".45"/><line x1="54" y1="84" x2="66" y2="84" opacity=".45"/><rect x="54" y="97" width="12" height="8" rx="2"/>',
