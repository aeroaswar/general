...
\~/.claude/skills/gstack/bin/gstack-timeline-log '{"skill":"ios-sync","event":"started","branch":"'"$\_BRANCH"'","session":"'"$\_SESSION\_ID"'"}' 2\>/dev/null &  
\_HAS\_ROUTING="no"  
...
\`\`\`bash  
\~/.claude/skills/gstack/bin/gstack-question-log '{"skill":"ios-sync","question\_id":"\<id\>","question\_summary":"\<short\>","category":"\<approval|clarification|routing|cherry-pick|feedback-loop\>","door\_type":"\<one-way|two-way\>","options\_count":N,"user\_choice":"\<key\>","recommended":"\<key\>","session\_id":"'"$\_SESSION\_ID"'"}' 2\>/dev/null || true  
\`\`\`  
...
2\. Read upstream version from \`$GSTACK\_HOME/ios-qa/.gstack-version\` (or the  
...
\`\`\`bash  
swift run --package-path "$GSTACK\_HOME/ios-qa/scripts/gen-accessors-tool" \\  
 gen-accessors --input "$APP\_SOURCE\_DIR" --output "$APP\_SOURCE\_DIR/DebugBridgeGenerated"  
\`\`\`  
...
2\. Read the upstream template at  
 \`$GSTACK\_HOME/ios-qa/templates/\<Name\>.swift.template\`.  
