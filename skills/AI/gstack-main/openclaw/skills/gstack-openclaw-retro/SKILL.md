...
\# Personal streak  
git log origin/main --author="\<user\_name\>" --format="%ad" --date=format:"%Y-%m-%d" | sort -u  
\`\`\`  
...
\- \*\*Completion status:\*\*  
 ...
 - DONE\_WITH\_CONCERNS ... generated but missing data (e.g., no prior retros for comparison)  
