...
本技能基于 \[Wikipedia:Signs of AI writing\](https://en.wikipedia.org/wiki/Wikipedia:Signs\_of\_AI\_writing)，由 WikiProject AI Cleanup 维护。那里记录的模式来自对维基百科上数千个 AI 生成文本实例的观察。  
